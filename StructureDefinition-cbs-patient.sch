...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-race']) &lt;= 1">extension with URL = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-race': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-ethnicity']) &lt;= 1">extension with URL = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-ethnicity': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-birthsex']) &lt;= 1">extension with URL = 'http://cbsig.chai.gatech.edu/StructureDefinition/cbs-birthsex': maximum cardinality of 'extension' is 1</sch:assert>
