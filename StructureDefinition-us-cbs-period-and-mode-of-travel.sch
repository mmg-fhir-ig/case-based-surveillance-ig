...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'dateOrPeriodOfTravel']) &lt;= 1">extension with URL = 'dateOrPeriodOfTravel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'modeOfTravel']) &lt;= 1">extension with URL = 'modeOfTravel': maximum cardinality of 'extension' is 1</sch:assert>
