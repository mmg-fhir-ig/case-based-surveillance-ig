...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'case-number']) &lt;= 1">extension with URL = 'case-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'case-type']) &lt;= 1">extension with URL = 'case-type': maximum cardinality of 'extension' is 1</sch:assert>
