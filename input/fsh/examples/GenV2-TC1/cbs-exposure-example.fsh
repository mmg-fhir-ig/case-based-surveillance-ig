...
Usage: #example
Description: "Exposure observation resource for the GenV2 Test Case 1 Patient"
...
* component[Country-of-Exposure].valueCodeableConcept = $PH-Country-ISO-3166-1#USA
