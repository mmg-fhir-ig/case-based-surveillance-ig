...
* section[reportingEntities].entry[0] = Reference(HAICA-TC-Person-Reporting)
* section[reportingEntities].entry[1] = Reference(HAICA-TC-Reporting-Source)
* section[labRelated].entry[0] = Reference(HAICA-TC-Lab-DiagnosticReport)
* section[labRelated].entry[+] = Reference(HAICA-TC-Lab-Observation)
* section[labRelated].entry[+] = Reference(HAICA-TC-Specimen)