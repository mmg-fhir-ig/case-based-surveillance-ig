...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile USPublicHealthTravelHistory
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://cbsig.chai.gatech.edu/StructureDefinition/us-cbs-program-specific-time-window']) &lt;= 1">extension with URL = 'http://cbsig.chai.gatech.edu/StructureDefinition/us-cbs-program-specific-time-window': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:component">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-address-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-address-extension': maximum cardinality of 'extension' is 1</sch:assert>
