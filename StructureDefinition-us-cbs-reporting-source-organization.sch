...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile USPublicHealthOrganization
  ...
  <sch:pattern>
    <sch:title>Organization.telecom.extension.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>Organization.telecom.extension.value[x] 1</sch:title>
    <sch:rule context="f:Organization/f:telecom/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
